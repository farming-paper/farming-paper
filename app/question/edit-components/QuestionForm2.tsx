...
import type { ITagWithCount, PartialDeep } from "~/types";
...
const QuestionForm2: React.FC<{
  existingTags: ITagWithCount[];
  initialQuestion: PartialDeep<Question>;
  onChange: WatchObserver<QuestionFormValues>;
}> = ({ existingTags, initialQuestion, onChange }) => {
