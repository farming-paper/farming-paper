...
export const questions: Question[] = [
  ...
  },
  {
    type: "short_order",
    message: [
      "순서: 대정맥 - ___ - ___ - ___ - 폐 - 폐정맥 - ___ - ___ 판 - ___ - 대동맥",
    ],
  ...
  },
  {
    type: "short_order",
    message: [
      "지속적 운동은 고혈압 증상을 개선시킨다. 그 이유:  ___, ___ 감소, 혈관의 ___, ___, ___ 증가",
    ],
  ...
  },
  {
    type: "short_order",
    message: [
      "인체는 운동수행을 위한 근수축 시 많은 양의 열에너지가 생성되지만 생체 내의 엄격한 체온조절 작용에 의하여 ___ 을 증가시키고 수분을 유지하여 약 ___ ℃의 정상 체온을 항상 유지하게 된다.",
    ],
    correct: ["발한", "37"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    type: "short_order",
    message: [
      "사전 건강검사 : 일반적으로 문진이나 개인기록카드를 통해 ___ 이나 ___ 를 평가하고 혈액 검사 및 소변검사 등을 시행한다.",
    ],
    correct: ["병력", "생활습관"],
    tags: ["운동과영양"],
  },
  {
    type: "short_order",
    message: [
      "운동부하검사 : 운동 중 일어날 수 있는 사고를 방지하기 위해 운동부하 심전도 진단이 필수적. ",
    ],
    correct: ["병력", "생활습관"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    ...
    message: [
      ...
      "심박수의 극단적인 상승",
      "점증운동부하에 따라 심박수 또는 혈압이 보통 증가하지만 증가하지 않는 경우, 또는 운동부하증가와 함께 ___혈압이 오히려 저하하는 경우",
      "이완기 혈압이 ___ mmHg 또는 그 이상의 상승이나 ___ mmHg이상으로 상승한 경우",
    ],
    correct: ["조기 심실 수축", "협심통", "2.0", "수축기", "20", "110"],
    tags: ["운동과영양"],
  },
  {
    type: "short_order",
  ...
  },
  {
    type: "short_order",
    message: [
      "운동강도 지표 - ___ (___) : 산소소비량을 기준으로 일상생활에서 쉽게 운동강도를 결정할 수 있는 방법. 신체활동을 하지 않는 안정 시 산소소비량(3.5Ml/kg/min)을 1MET으로 하여 각 신체활동의 상대강도를 결정할 때 이용.",
    ],
    correct: ["대사당량", "MET"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    type: "short_order",
    message: [
      "비타민 A 보충제는 섭취할 필요가 ___ (있다/없다). 다양한 과잉증이 나올 수 있음. ___ 손실을 초래. 과량의 섭취가 운동수행능력을 높인다는 근거 부족",
    ],
    correct: ["없다", "뼈"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    type: "short_order",
    message: [
      "비타민 D는 과량으로 섭취하였을 때 운동수행능력에 크게 영향을 주지 않음.",
    ],
    correct: ["???"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    type: "short_order",
    message: [
      "비타민 B1 : 다른 말로 ___ . ___, ___ 형태의 조효소로 전자전달계에서 에너지 생성에 관여. 과량 섭취할 필요가 없음.",
    ],
  ...
  },
  {
    type: "short_order",
    message: [
      "___ : 니코틴산과 니코틴아마이드를 총칭하는 일반명. 조효소인 ___ (근육 글리코겐에서), ___ (지방에서)의 형태로 환원효소를 보조하는 역할. 결핍되면 ___ 가 발생할 수 있음. ___ 이 필요한 운동은 오히려 보충이 권장되지 않는다.",
    ],
  ...
  },
  {
    type: "short_order",
    message: [
      "엽산 : 조효소 형태는 ___ . ___ 전이반응의 조효소로 작용. DNA 및 RNA 합성, 헤모글로빈 생성에 작용한다. 엽산 보충이 운동수행능력을 향상시킨다는 과학적 근거 부족. 결핍시 빈혈.",
    ],
    correct: ["THF", "단일탄소"],
    tags: ["운동과영양"],
  },
  {
    type: "short_order",
    message: [
      "비타민 B12: ___ 를 함유한 코발아민 화합물. 장내 세균에 의해서 일부 합성. ___ 형성에 중요한 역할. ___ 합성에도 필수적. 과량의 보충제가 운동수행능력을 높인다는 근거는 없음. ___, ___ 의 경우 섭취하면 좋음. 결핍 시 빈혈",
    ],
    correct: ["코발트", "적혈구", "DNA", "노인", "채식주의자"],
    tags: ["운동과영양"],
  },
  {
    type: "short_order",
  ...
  {
    type: "short_multi",
    message: ["결핍 시 빈혈을 일으킬 수 있는 것 두 개"],
    correct: ["비타민 B12", "엽산"],
    tags: ["운동과영양"],
  },
  {
  ...
  },
  {
    type: "short_order",
    message: [
      "___ : 남성 호르몬인 테스토스테론과 유사하여 남성호르몬이 부족한 선수나 근육 증가를 통한 근력 향상을 목적으로 사용됨. 부작용 심함.",
    ],
    correct: ["동화작용 스테로이드"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    type: "short_order",
    message: [
      "___ : 미토콘드리아 막을 통과할 수 없는 지방산을 내막으로 운송시켜 베타 산화를 가능하게 하는 물질. 구강 섭취와 정맥 투여의 결과가 다르다. ",
    ],
    correct: ["카르니틴"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    ...
    options: [
      "아침에 운동하는 것이 저녁에 운동하는 것보다 좋다.",
      "저녁에 운동하는 것이 아침에 운동하는 것보다 좋다.",
    ],
    tags: ["운동과영양"],
  },
  {
  ...
  },
  {
    type: "short_order",
    message: [
      "혈중 ___ 혹은 ___ 이 비정상적으로 증가하거나 ___ 이 지나치게 감소한 상태.",
    ],
  ...
  },
  {
    type: "short_order",
    message: [
      "___ 골다공증 : 원발성(1차)ㄹ으로, 소주골 감소에 의한 척추압박골절이 특징.",
    ],
    correct: ["폐경후"],
    tags: ["운동과영양"],
  },
  {
    type: "short_order",
    message: [
      "___ 골다공증 : 치밀골과 소주골의 감소. 대퇴골 경부 골절과 원위 골절. 주로 70세 이상의 남녀가 해당.",
    ],
    correct: ["노인성"],
    tags: ["운동과영양"],
  },
  ...
  },
  {
    ...
    message: [
      ...
      "적어도 ___ ~ ___ 개월이 필요함.",
      "___ 의 근육을 강화하기 위해 낮은 강도로 천천히 수행할 것을 권장함.",
      "넘어지는 걸 잘 방지해야 함.",
    ],
