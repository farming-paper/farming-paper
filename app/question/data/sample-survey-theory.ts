...
export const questions: Partial<QuestionContent>[] = [
  ...
  //   type: "short_order",
  //   message: [
  //     " 확률비례추출법은 조사변수의 ___ 와 집락 내의 조사단위의 ___ 와 양의 상관관계가 뚜렷할 때 효율적이다. 각 추출단위가 표본으로 추출될 확률이 집락의 크기에 비례하는 추출법이다.",
  //   ],
  //   corrects: ["합계", "수"],
  //   tags: ["표본조사론"],
  // },
