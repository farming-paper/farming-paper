...
export default function Login() {
  ...
  return (
    <DefaultLayout className="bg-primary-700">
      <div className="">
        <div className="max-w-2xl px-6 py-16 mx-auto text-center">
          ...
          <p className="mb-12 text-2xl font-semibold leading-tight text-primary-200">
            분야를 가리지 않는,
            <br />
          ...
          <hr className="w-64 h-1 my-16 border-0 rounded bg-white/30 dark:bg-primary-700" />
          <div className="absolute px-4 -translate-x-1/2 text-primary-200 bg-primary-700 left-1/2 dark:bg-primary-900">
            <Carrot />
          </div>
        </div> */}
          <div className="flex flex-wrap justify-center gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium transition border border-transparent rounded-md shadow-xl text-primary-900 bg-primary-400 hover:bg-primary-300"
            >
